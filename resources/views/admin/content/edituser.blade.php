                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('name', $users[0]->name, ['class' => 'form-control', 'id' => 'username']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('apell', $users[0]->user_lastname, ['class' => 'form-control', 'id' => 'userapell']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('phone', $users[0]->user_phone, ['class' => 'form-control', 'id' => 'userphone']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('email', $users[0]->email, ['class' => 'form-control', 'id' => 'useremail']) !!}
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('nikname', $users[0]->user_nickname, ['class' => 'form-control', 'id' => 'usernikname']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: text('web', $users[0]->user_web, ['class' => 'form-control', 'id' => 'userweb']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            {!! Form:: textarea('remarks', $users[0]->profile_description, ['class' => 'form-control', 'rows' => '3', 'id' => 'userremarks']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px; line-height: 150px;">
                                                                  <img src="{{$users[0]->profile_pic}}" alt="" /></div>
                                                                <div>
